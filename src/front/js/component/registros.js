            ...
            <form id="form">
              <div className="field ">
                ...
                <datalist id="objective">
                  ...
                  <option value="Zona media" />{" "}
                  {/* 5 ejercicios zona abdominal */}
              ...
              <div className="field ">
                <input
                  className="input-field"
                  placeholder="¿Alguna lesión o prescripción médica?"
                  list="medical"
                  value={medical}
                  onChange={(e) => {
              ...
              <textarea
                className="input-field mt-3 border border-warning p-3"
                placeholder="Aquí puedes detallar cualquier aspecto relevante sobre las preguntas"
                name="message"
                id="message"
                rows="2"
                cols="30"
